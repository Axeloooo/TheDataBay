  ...
  const steps = [
    {
      ...
      description:
        "Describe what your model needs in plain language. TheDataBay ranks datasets by semantic similarity — so the right asset surfaces even when the listing uses different words.",
    },
    {
      icon: Shield,
